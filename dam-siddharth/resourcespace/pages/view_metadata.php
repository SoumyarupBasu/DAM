...
<div id="Metadata">
    <div class="NonMetadataProperties">
        ...
        // Show Title (field 8) in resource details when original filename is used as top heading
        global $view_title_field, $filename_field;
        if ($view_title_field != 8) {
            $title_value = get_data_by_field($resource['ref'], 8);
            if ($title_value != '') {
                ?>
                <div class="itemNarrow">
                    <h3><?php echo escape($lang["title"] ?? "Title"); ?></h3>
                    <p><?php echo escape(i18n_get_translated($title_value)); ?></p>
                </div>
                <?php
            }
        }
