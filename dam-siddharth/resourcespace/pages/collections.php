...
if ($collection != "" && $collection != "undefined") {
    ...
    if (($k == "" || $internal_share_access) && $collection == "new") {
        ...
        // Force cache clear for the new collection to ensure ID is displayed
        clear_query_cache("collection");
        clear_query_cache("collection" . $new);
        clear_query_cache("featured_collections");
        if (isset($GLOBALS['get_collection_cache'][$new])) {
            unset($GLOBALS['get_collection_cache'][$new]);
        }
